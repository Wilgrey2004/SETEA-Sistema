...
namespace SETEA_Sistema.Gestion_Productos
{
        public partial class Codigos_Agregar_editar : MaterialForm
        {
                ...
                public int idCargada = 0;
                private bool CargoConId = false;
                public Codigos_Agregar_editar() {
                        ...
                        Encabezado.Text = "Agregar Nuevo Codigo";
                }
                public Codigos_Agregar_editar( int id ) {
                        ...
                        CargoConId = idCargada > 0 ? true : false;

                        Encabezado.Text = "Editar Codigo";
                }

                private void CargarNombreYIdParaEditar() {
                        using (SeteaEntities1 db = new SeteaEntities1())
                        {
                                var query = db.Codigo_De_Productos.FirstOrDefault(x => x.ID == idCargada);
                                ...
                                if (query == null)
                                {
                                        ...
                                        MyIdSeleccionadoTxt.Text = query.ID.ToString();
                                        MyCodigoDeBarras.Text = query.CodigoDelProducto;
                        }
                }
                ...
                private void MyListaDeCodigos_DataError( object sender, DataGridViewDataErrorEventArgs e ) {
